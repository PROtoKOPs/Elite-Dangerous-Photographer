...
* Хотите хранить скриншоты в отдельной папке? Программа сама переместит переименованные скриншоты в указанное место.
* Конвертация скриншотов: После завершения вашей фотосессии больше не придется беспокоиться о преобразовании скриншотов из .bmp в форматы .png или .jpg, поскольку программа возьмет эту задачу на себя.
...
Просто укажите программе путь к вашим скриншотам и папке с логами (обычно это %userprofile%\Saved Games\Frontier Developments\Elite Dangerous). После этого нажмите Сохранить и возвращайтесь в игру.
